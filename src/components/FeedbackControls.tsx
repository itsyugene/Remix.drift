...
// Light-themed thumbs feedback, sits on the cream DRIFT v3 card.
    ...
    <div className="mt-3 pt-3 border-t border-dashed border-[#d8d2bf]">
      <div className="flex items-center gap-2 flex-wrap">
        <button
          ...
          className={`${thumbBase} ${
            feedback?.vote === "up"
              ? "border-[#1f8a4c] bg-[#dcefe2] text-[#1f8a4c]"
      ...
      {feedback && (
        <input
          ...
          className="mt-2 w-full rounded-lg border border-[#d3ceb7] bg-white px-2.5 py-2 text-[0.82rem] text-[#12131a] outline-none focus:border-[#ff4522]"
        />
      )}
    </div>
  );
